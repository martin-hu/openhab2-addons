...
import static org.openhab.binding.luxtronik1.internal.lux.Lux1Constants.*;

/**
 * The {@link LuxRegisterMapper} is responsible for mapping luxtronik1 registers into channels.
 *
 * @author Boris Krivonog - Initial contribution
 */
public class LuxRegisterMapper {
    public static final LuxRegisterMapper REGO600;
    ...
    private LuxRegisterMapper(Map<String, Channel> mappings) {
    ...
    static {
        final Map<String, Channel> mappings = new HashMap<>();
        {
            ...
            */
            ...
            // Device values
            mappings.put(Luxtronik1BindingConstants.CHANNEL_GROUP_DEVICE_VALUES + "firmwareVersion", ChannelFactory.unitless((short) 509, 1));
            /*
        ...
        REGO600 = new LuxRegisterMapper(mappings);
    }
}
